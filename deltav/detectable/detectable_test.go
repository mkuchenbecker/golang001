...
func TesDetectableLookback(t *testing.T) {
	...
	req := DetectRequest{Pos: controller.Position{X: 1, Y: 0, Z: 0, T: 3},
...
func TestDetectableRange(t *testing.T) {
	...
	req := DetectRequest{Pos: controller.Position{X: 0, Y: 0, Z: 0, T: 10},
	...
	req = DetectRequest{Pos: controller.Position{X: 0, Y: 0, Z: 0, T: 100},
		Range: 10, Filter: []PropertyType{GammaRadiation}}
...
func TestDetectableMultiItem(t *testing.T) {
	...
	req := DetectRequest{Pos: controller.Position{X: 0, Y: 0, Z: 0, T: 12},
		Range: 10, Filter: []PropertyType{}}
...
func TestDetectPerformance(t *testing.T) {
	...
	beforeTime := time.Now()
	req := DetectRequest{Pos: controller.Position{X: 0, Y: 0, Z: 0, T: 60},
		Range: 10, Filter: []PropertyType{}}
